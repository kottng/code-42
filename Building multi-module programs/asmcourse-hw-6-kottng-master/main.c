...
int main (int argc, char *argv[]) {
    ...
    int it_f2;
    int it_f3;
    point23 = root(f2, f3, diff_f2, diff_f3, -0.2, 0.0, 0.000001);
    it_f1 = count_of_iters;
    count_of_iters = 0;
    point12 = root(f1, f2, diff_f1, diff_f2, 0.4, 0.5, 0.000001);
    it_f2 = count_of_iters;
    count_of_iters = 0;
    point13 = root(f1, f3, diff_f1, diff_f3, -1.9, -1.75, 0.000001);
    it_f3 = count_of_iters;
    count_of_iters = 0;
    area_f1 = integral(f1, point13, point12, 0.000001);
    area_f2 = integral(f2, point23, point12, 0.000001);
    area_f3 = integral(f3, point13, point23, 0.000001);
